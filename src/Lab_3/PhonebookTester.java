...
class Contact {
    ...
    public static void main(String[] args) throws InvalidNameException, InvalidNumberException {
        Contact test = new Contact("gjuro", new String[5]);
        Contact test2 = new Contact("Stefoз4", new String[5]);
        Contact test3 = new Contact("Stefan 4", new String[5]);
        Contact test4 = new Contact("StefЈан", new String[5]);
    }
    public Contact(String name, String[] phone_numbers) throws InvalidNameException, InvalidNumberException {
        if(name.length() <= 4 ||
                name.length()>10 ||
                !name.replaceAll("[^a-zA-Z]", "").equals(name.replaceAll("[\\s0-9]",""))
        )
